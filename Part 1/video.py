import cv2
import os
from ultralytics import YOLO  # or use torch.hub if you're using YOLOv5
import numpy as np

# PARAMETERS
main_folder_path = os.path.dirname(os.path.abspath(__file__))
VIDEO_PATH = r"C:\Users\cadsegev\Desktop\Image-Processing-in-OR-Project\id_video_data\20_2_24_1.mp4"
